...
const Profile: React.FC<ProfileProps> = ({ user }) => {
	return (
      ...
      <span className='inline-block text-sm italic text-brand-taupe'>
          You have no children. The ordering process is simplified if you add children to your account.
        </span>
