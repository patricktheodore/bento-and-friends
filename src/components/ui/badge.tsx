...
const badgeVariants = cva(
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-brand-dark-green text-brand-cream shadow hover:bg-brand-dark-green/80",
        secondary:
          "border-transparent bg-brand-taupe text-brand-cream hover:bg-brand-taupe/80",
        destructive:
