	...
	const [orderItems, setOrderItems] = useState<OrderItem[]>([
        {
            ...
            childId: '',
            addOnIds: [],
            probioticId: state.probiotics.find(yogurt => (yogurt.display.toLowerCase().includes('yoghurt') && yogurt.isActive))?.id || null,
            fruitId: state.fruits.find(fruit => (fruit.display.toLowerCase().includes('mixed') && fruit.isActive))?.id || null, //and is active
            orderDate: undefined,
            isMainOnly: false,
        },
    ]);
	...
	const addOrderItem = () => {
        setOrderItems([
            ...orderItems,
            {
                ...
                childId: '',
                addOnIds: [],
                probioticId: state.probiotics.find(yogurt => yogurt.display.toLowerCase().includes('yoghurt'))?.id || null,
